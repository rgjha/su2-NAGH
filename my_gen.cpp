...
Complex genmat[NUMGEN][NCOLOR][NCOLOR] ;

Complex tr[NUMGEN][NUMGEN], strconst[NUMGEN][NUMGEN][NUMGEN] ;


void initgen(void) ;
void vectomat(Complex [NUMGEN], Complex [NCOLOR][NCOLOR]) ;
...
Complex fund[NCOLOR][NCOLOR] ; 
  ...
  for(aa=0;aa<NUMGEN;aa++) {
    ...
    for(ii=0;ii<NUMGEN;ii++) adj[ii] = Complex(0.0,0.0) ;
...
void vectomat(Complex vec[NUMGEN], Complex mat[NCOLOR][NCOLOR])
{
int ii,jj ;
Complex mult ;
